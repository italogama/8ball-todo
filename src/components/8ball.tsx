    ...
    <div className="relative flex w-full h-screen items-center justify-center">
      ...
      <div className=" flex flex-col items-center justify-center gap-8">
        ...
        <form className="flex flex-col items-center justify-center" onSubmit={handleSubmit}>
          <input className="w-[300px] h-[50px] rounded-lg focus:border-2 focus:border-[#ffedd5]  text-center text-2xl text-black" type="text" placeholder="Enter a todo" value={todo} onChange={(e) => setTodo(e.target.value)} />
        </form>
      </div>
    </div>
  );
